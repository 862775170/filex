...
public class DashBoardController {
	...
	public ResponseEntity<Object> getFileExchangeCount30day() {
		List<Map<String, Object>> result = dashBoardService.getFileExchangeCount30day();
	...
	public ResponseEntity<Object> getReceiveFileCountTop10() {
		List<Map<String, Object>> result = dashBoardService.getReceiveFileCountTop10();
		return new ResponseEntity<Object>(result, HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getReceiveRuleTop10() {
		List<Map<String, Object>> result = dashBoardService.getReceiveRuleTop10();
		return new ResponseEntity<Object>(result, HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getUserCount() {
		int count = dashBoardService.getUserCount();
	...
	public ResponseEntity<Object> getRuleCount() {
		int count = dashBoardService.getRuleCount();
		return new ResponseEntity<Object>(count, HttpStatus.OK);
	}
}
